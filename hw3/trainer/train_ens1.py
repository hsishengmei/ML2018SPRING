...
def train(X, Y, model_path = 'trainer/tmp/model_ens1.h5'):
    
    X = X[:,:,:,np.newaxis] / 255
    X, valX, Y, valY = train_test_split(X, Y, test_size=0.1, random_state=13)
...
if __name__ == '__main__':
    ...
    train(X, Y, model_path = 'tmp/model_ens1.h5')
