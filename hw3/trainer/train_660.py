...
def train(X, Y, model_path = 'trainer/tmp/model_660.h5'):
    
    X = X[:,:,:,np.newaxis] / 255
    X, valX, Y, valY = train_test_split(X, Y, test_size=0.1, random_state=3)
    ...
    model.fit_generator(train_datagen.flow(X, Y, batch_size=256),
...
if __name__ == '__main__':
    ...
    train(X, Y, model_path = 'tmp/model_660.h5')